...
<div class="main">
	<div id="profile" >
		<i><h2 style="margin-left:370px;">Developer Profile</h2></i>
			...
			if (session != null) {
				if (session.getAttribute("emailId") != null) {
					...
					//"select * from userid WHERE id = '" + id + "' 
				      //AND pwd = '" + pwd + "'";
					String dev_sql ="SELECT * FROM DEVELOPER where DEV_EMAILID = ?";
					...
					while(resultSet_dev.next()){
						dev_id=resultSet_dev.getInt("DEV_ID");
		...
		%>
		 ...
		 <div class="row">
		 	 <div class="col-sm-6">
		 	 	 ...
		 	 	 <% if(resultSet_dev.getString("DEV_GEN").equals(male)){ %>
    		...
    		<div class="col-sm-6">
    			<div class="container">
	    			<i><b>NAME : <%=resultSet_dev.getString("DEV_NAME") %></b></i>
				    <br><br>
				    <i><b>DATE OF BIRTH : <%=resultSet_dev.getString("DEV_DOB") %></b></i>
				    <br><br>
				    <i><b>SEX : <%=resultSet_dev.getString("DEV_GEN") %></b></i>
				   	<br><br>
				    <i><b>EMAIL ID : <%=resultSet_dev.getString("DEV_EMAILID") %></b></i>
				    <br><br>
				    <i><b>JOB POSITION : <%=resultSet_dev.getString("DEV_JOBPOS") %></b></i>
				    <br><br>
				    <i><b>EXPERIENCE : <%=resultSet_dev.getString("DEV_EXP") %></b></i>
				    <br><br>
    			</div>
		 	</div>
		</div>
	...
	<br><br>
		<div id="projects">
		<% String proj_sql = "SELECT * from PROJECT where DEV_EMAILID = ?"; 
				    ...
				    <div class="panel-heading">Project Details</div>
						...
						<div class="panel panel-default">
				    		<div class="panel-heading"><i>Project <%=count%></i></div>
					    		...
					    		<a href="developer_project.jsp">CLICK HERE TO UPDATE</a>
					    		</div>
				  		</div>
